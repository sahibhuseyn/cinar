...
@section('content')
    ...
    <div class="container-fluid">
        <div class="row clearfix">
            @foreach($settings as $count => $setting)
                    ...
                    <div class="card">
                        <div class="header">
                            <h2>
                                ...
                                <form action="{{ route('admin_setting_delete', $setting->id) }}" method="post" class="pull-right">
                                    {{ csrf_field() }}
                            ...
                            <form action="{{ route('admin_setting_update', $setting->id) }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row clearfix">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            <div class="form-line">
                                                <input type="text" class="form-control" name="work_hours" value="{{ $setting->work_hours }}">
        ...
        <div class="row clearfix">
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                <div class="card">
                    ...
                    <div class="body">
                        <form action="{{ route('admin_setting_add') }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            ...
                            <div class="row clearfix">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <div class="form-line">
                                            <input type="text" class="form-control" name="work_hours" placeholder="Work hours">
